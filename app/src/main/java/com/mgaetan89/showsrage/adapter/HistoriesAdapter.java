...
public class HistoriesAdapter extends RecyclerView.Adapter<HistoriesAdapter.ViewHolder> {
	...
	public void onBindViewHolder(ViewHolder holder, int position) {
		...
		if (holder.date != null) {
			...
			holder.date.setText(holder.date.getResources().getString(R.string.spaced_texts, statusString, DateTimeHelper.INSTANCE.getRelativeDate(history.getDate(), "yyyy-MM-dd hh:mm", 0).toString().toLowerCase()));
		}
	}
