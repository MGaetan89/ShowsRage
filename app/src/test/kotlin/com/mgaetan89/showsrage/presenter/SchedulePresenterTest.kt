...
class SchedulePresenterTest {
    ...
    var airDate: CharSequence? = null

    @Parameterized.Parameter(2)
    var airDateTime: String? = null

    @Parameterized.Parameter(3)
    var airTime: String? = null

    @Parameterized.Parameter(4)
    var airTimeOnly: String? = null
    ...
    companion object {
        ...
        fun data(): Collection<Array<Any?>> {
            ...
            return listOf(
                    ...
                    arrayOf(gson.fromJson("{airdate: null, airs: null, episode: 1, network: null, quality: null, season: 10, show_name: null, tvdbid: 123}", Schedule::class.java), null, null, null, null, 1, "", "https://127.0.0.1:8083/api/apiKey/?cmd=show.getposter&tvdbid=123", "", 10, ""),
